...
common_words <- c("a", "i", "the", "this", "we")
...
for (loop_step_id in loop_df$loop_step_id[5:5]) {   
    ...
    for (row_pos in seq(1:nrow(sentences_df))) {    
        ...
        if (toString(loop_step_id) >= toString(loop_step_id_set[1])) {
            ...
            row_word_2 <- sentences_df[row_pos, "word_2"]
            row_word_3 <- sentences_df[row_pos, "word_3"]
            row_word_4 <- sentences_df[row_pos, "word_4"]
            row_word_n <- sentences_df[row_pos, "word_n"]
        }
...
print(sentences_df[sentences_df$id == 4986, "words_lst"])
print(sentences_df[sentences_df$id == 4221, "words_lst"])
