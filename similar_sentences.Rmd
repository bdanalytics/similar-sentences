...
0. 8451       7346 - sentence_ids; Add n_m2 comparison
...
sentences_df <- myimport_data(
    ...
    "sentences.txt", nrows=10000, stringsAsFactors=FALSE)
...
comparison_pairs_n_est <- (nrow(sentences_df) ^ 2) * 0.0005 * 1.05
...
common_words <- c("2007", "2008", 
                "a", "about", "after", "again", "ago", "agora", "alex", "all", "also", 
                    "am", "american", "and",
                    "any", "alaska", "alone", "anything", "are", "as", "at", 
                    "australia", "australian",
                "back", "be", "because", "been", "believe", "best", "bills", 
                    "britney", "business", "but", "by", 
                "campaign", "can", "china", "climate", "com", "companies", 
                    "content", "country", 
                    "crisis", "customers", 
                "day", "did", "do", "done", "dont", "during",
                "e", "economy", "el", "electoral", "en", "endeavor", "environment", 
                    "es", "esta", 
                    "eu", "even", "events", "every", "everybody", "everyone", 
                    "experience",
                "facilities", "families", "feel", "for", "from", "fuel", "fund",
                    "future", 
                "games", "government", "grandchildren", "guy", 
                "had", "happens", "has", "have", "he", "hell", "helpful", "here",
                    "hes",
                    "hey", "him", "his", "home", "hope", "hopefully", "house", 
                    "how", 
                "i", "id", "if", "il", "im", "in", "industry", "into", "interests", 
                    "is", "issues", "it", "its", "ive",
                "just",
                "kent", "know", 
                "la", "las", "last", "law", "les", "life", "like", "lives", "lo",
                    "looked", "looking", "love", 
                "made", "man", "mas", "maybe", "me", "media", "members", "mine",
                    "more", "mr", "my", "myself",
                "n", "nation", "night", "no", "nos", "not", "now", "nu", 
                "o", "of", "oh", "on", "one", "only", "opportunity", "our", 
                    "out", "outcome", "own",
                "para", "parece", "past", "people", "percent", "period", "place",
                    "plazo", 
                    "please", "politics", "por", "problem", "program", "public", 
                "que", "results", "right", "run",
                "s", "said", "saya", "se", "secure", "selecci", "serious", "service",
                    "she", "shes", "should", "si", "side", "so", "soil", "son",
                    "staff", "state", "story", "study", "stuff", 
                "tengo", "that", "thats","the", "them", "themselves", "then", 
                    "there", "theres", 
                    "these", "they", "theyre", "thing", "think", "this", "though", 
                    "time", "times", "tinha", "to", "today", "treatment", "tried",
                    "two",
                "un", "under", "unless", "up", "us",
                "very",
                "want", "was", "way", "we", "week", "weeks", "well", "were", "weve", 
                    "what", "when", "while", "white", "will", "with", "work", "working", 
                    "world", "words", "would", "wrong", 
                "year", "years", "yo", "you", "youre")
...
common_words <- c("2007", "2008", 
                "a", "about", "after", "again", "ago", "agora", "alex", "all", "also", 
                    "am", "american", "and",
                    "any", "alaska", "alone", "americans", "anything", "are", 
                    "as", "at", 
                    "australia", "australian", "away",
                "back", "be", "because", "been", "believe", "best", "bill", "bills", 
                    "blog", "both", "britney", "business", "but", "by", 
                "campaign", "can", "change", "children", "china", "choice", "climate", 
                    "cold", "com", "commitment", "companies", 
                    "company", "con", "content", "country", 
                    "crisis", "customers", 
                "date", "day", "days", "did", "didnt", "disappointed", "do", "done", 
                    "dont", "during",
                "e", "economy", "el", "electoral", "en", "endeavor", "environment", 
                    "equal", "es", "esta", 
                    "eu", "even", "events", "every", "everybody", "everyone", 
                    "experience",
                "facilities", "families", "feel", "first", "fit", "for", 
                    "formula", "from", 
                    "fuel", "fund", "future", 
                "games", "gas", "good", "got", "government", "grandchildren", "guy", 
                "had", "happens", "has", "have", "he", "heart", "hell", 
                    "helpful", "here",
                    "hes",
                    "hey", "him", "his", "history", "home", "hope", "hopefully",
                    "house", 
                    "how", 
                "i", "id", "if", "il", "im", "in", "industry", "infection", "into",
                    "interests", "iraq", 
                ...
                "la", "las", "last", "law", "les", "life", "like", "lives", "lo",
                    "looked", "looking", "love", 
                "made", "man", "many", "market", "mas", "maybe", "me", "media",
                    "members",
                    "mine",
                    "more", "most", "mr", "my", "myself",
                "n", "nation", "need", "never", "next", "night", "no", "nos", 
                    "not", "now", "nu", 
                "o", "obama", "of", "oh", "on", "one", "only", "opportunity", "our", 
                    "out", "outcome", "overall", "own",
                "para", "parece", "past", "people", "percent", "period", "place",
                    "plazo", 
                    "please", "policy", "politics", "por", "position", "problem",
                    "process", 
                    "program",
                    "public", 
                "que", "results", "right", "run",
                "s", "said", "saya", "se", "secure", "selecci", "serious", "service",
                    "she", "shes", "should", "si", "side", "so", "soil", "son",
                    "staff", "state", "stop", "story", "study", "stuff", 
                "tengo", "that", "thats", "the", "them", "themselves", "then", 
                    "there", "theres", 
                    "these", "they", "theyre", "thing", "think", "this", "though", 
                    "time", "times", "tinha", "to", "today", "treatment", "tried",
                ...
                "un", "under", "unless", "up", "us",
                "very",
                "want", "war", "was", "way", "we", "week", "weeks", "well", 
                    "were", "weve", 
                    "what", "when", "whenever", "while", "white", "will", "with",
                    "work", "working", 
                    "world", "words", "would", "wrong", 
