...
comparison_pairs_n_est <- (nrow(sentences_df) ^ 2) * 0.0010 * 1.05
...
max_edit_distance_row <-     
    comparison_pairs_df[which.max(comparison_pairs_df$edit_distance), ]
print("max_distance:")
print(max_edit_distance_row)
print(sentences_df[sentences_df$id == max_edit_distance_row$query_id, "words_lst"])
print(sentences_df[sentences_df$id == max_edit_distance_row$compare_id, "words_lst"])
