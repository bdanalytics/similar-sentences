...
sentences_df <- myimport_data(
    ...
    "sentences.txt", nrows=100, stringsAsFactors=FALSE)
...
compare_pairs_row_pos <- 2
compare_pairs_row_id1 <- comparison_pairs_df[compare_pairs_row_pos, "query_id"]
compare_pairs_row_id2 <- comparison_pairs_df[compare_pairs_row_pos, "compare_id"]
compare_pairs_row_words_lst1 <- sentences_df[sentences_df$id == compare_pairs_row_id1, "words_lst"]
compare_pairs_row_words_lst2 <- sentences_df[sentences_df$id == compare_pairs_row_id2, "words_lst"]
