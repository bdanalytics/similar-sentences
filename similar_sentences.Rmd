...
names(comparison_pairs_query_id_freq_df)[2] <- "freq"
print(myplot_histogram(comparison_pairs_query_id_freq_df, "freq"))
myprint_df(subset(comparison_pairs_df, 
                  query_id == subset(comparison_pairs_query_id_freq_df, 
                                freq == max(comparison_pairs_query_id_freq_df$freq))$query_id
          ))
...
sentence_edit_distance_old <- function(words_lst1, words_lst2) {
    ...
    for (row in seq(1, nrow(comparison_pairs_df))) {
        ...
        if (toString(loop_step_id) >= toString(loop_step_id_set[3])) {
            comparison_pairs_df[row, "edit_distance"] <- 
                sentence_edit_distance_old(row_words_lst1, row_words_lst2)
        }
    }
