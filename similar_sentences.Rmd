...
sentences_df <- myimport_data(
    ...
    "sentences.txt", nrows=5000, stringsAsFactors=FALSE)
...
common_words <- c("a", "also", "he", "i", "in", "is", "the", "this", 
                  "we", "well", "when", "with")
...
comparison_pairs_df <- data.frame(query_id=rep(-1, comparison_pairs_n_est),
                                  ...
                                  is.common_query_word_1=rep(FALSE, 
                                                             comparison_pairs_n_est))
common_words <- c("a", "also", "and", "he", "i", "if", "in", "is", "it", "its", 
                  "la", 
                  "n", "no", 
                  "that", "the", "there", "this", 
                  "we", "well", "when", "with")
...
print(myplot_histogram(comparison_pairs_df, "edit_distance"))
...
comparison_pairs_srtd_df <- orderBy(~ - edit_distance + query_id + compare_id, 
                                    comparison_pairs_df)
print(comparison_pairs_srtd_df[1, ])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$query_id[1], "words_lst"])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$compare_id[1], "words_lst"])
print(comparison_pairs_srtd_df[2, ])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$query_id[2], "words_lst"])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$compare_id[2], "words_lst"])
print(comparison_pairs_srtd_df[3, ])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$query_id[3], "words_lst"])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$compare_id[3], "words_lst"])
print(comparison_pairs_srtd_df[4, ])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$query_id[4], "words_lst"])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$compare_id[4], "words_lst"])
print(comparison_pairs_srtd_df[5, ])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$query_id[5], "words_lst"])
print(sentences_df[sentences_df$id == comparison_pairs_srtd_df$compare_id[5], "words_lst"])
